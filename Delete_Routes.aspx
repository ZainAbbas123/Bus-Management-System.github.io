<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Delete_Routes.aspx.cs" Inherits="WebApplication12.Delete_Routes" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <br />
      Enter Route Number which you want to delete  <asp:TextBox ID="get_route_No" runat="server"></asp:TextBox>
        <br />
        <br />
